...
In the [next chapter](03.-The-Refraction-API-%7C-Tool-Calling.md#31-decorating-a-tool), we will discuss how to use the refraction decorator
...
These are very commonly used in LLM prompts. Check [here](https://github.ibm.com/research-dba/refraction/blob/main/tests/from_deployment/test_untyped_inputs.py#L14) for an example.

> Check [here](03.-The-Refraction-API-%7C-Tool-Calling.md)
